 ...
 * 2) api key
 * 3) page number. By default it is set to 1 but the ListController class may modify it
 * This basic object will be wrapped by proper query objects (for example search, sections, tag
 * depending on search type)
 * At this moment (News Reader App stage 1) only GuardianSearchQuery class will be delivered but
