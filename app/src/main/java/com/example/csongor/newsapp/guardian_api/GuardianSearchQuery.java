...
public class GuardianSearchQuery implements GuardianQuery {
    ...
    private static final String API_KEY ="&api-key="+ BuildConfig.GUARDIAN_QUERY_API_KEY;
    ...
    // set up page size
    private static final String PAGE_SIZE_SYMBOL = "&page-size=30";
    private int mPage;
     ...
     * otherwise there can be no results. By default let the ListController to set this value
     *
