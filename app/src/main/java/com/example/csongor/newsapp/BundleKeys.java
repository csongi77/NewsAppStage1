...
import static com.example.csongor.newsapp.BundleKeys.BUNDLE_QUERY_PARAM;
...
@StringDef({BUNDLE_QUERY,BUNDLE_RESULT_LIST,BUNDLE_PAGES,BUNDLE_CURRENT_PAGE, BUNDLE_STATUS, BUNDLE_QUERY_PARAM})
public @interface BundleKeys {
    ...
    String BUNDLE_QUERY_PARAM="BUNDLE_QUERY_PARAM";
}
